...
def average_sales():   #This function calculates the average number of sales per game for each Developer and stores the results in the analyzed_data dictionary#
...
def data_analysis():   #This function analyzes data in the game_data dictionary and stores the results in the analyzed_data dictionary#
...
while i < 10000:   #Main block of code, opens the game_info.json file, stores the dictionary in game_data, generates the random game data through game_generator.generate_game_data() and runs the data_analysis() function#
